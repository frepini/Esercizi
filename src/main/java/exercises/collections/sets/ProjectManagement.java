...
class Task {
    ...
    public void setProject(Project project) {
        /*
         Bisogna controllare che il task attuale non sia già assegnato a un progetto. In tal caso, dobbiamo
         rimuovere il task dal progetto al quale è già assegnato
         */
        if (Objects.nonNull(this.project) && this.project.getTasks().contains(this)) {
            this.project.removeTask(this);
        }
        /*
        Nel caso in cui il progetto passato come parametro non sia nullo, dobbiamo aggiungere il task attuale
        alla lista dei task di tale progetto
         */
