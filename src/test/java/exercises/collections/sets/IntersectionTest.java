...
class IntersectionTest {
    ...
    void intersection() {
        ...
        assertEquals(Set.of(), Intersection.intersection(Set.of(), Set.of(4, 5, 6)));
        assertEquals(Set.of(), Intersection.intersection(Set.of(1, 2, 3), Set.of()));
        assertEquals(Set.of(4, 5, 6), Intersection.intersection(Set.of(1, 2, 3, 4, 5, 6), Set.of(4, 5, 6)));
        assertEquals(Set.of(1, 2, 3), Intersection.intersection(Set.of(1, 2, 3), Set.of(1, 2, 3)));
    }
    ...
    void intersectionRetainAll() {
        ...
        assertEquals(Set.of(), Intersection.intersectionRetainAll(Set.of(), Set.of(4, 5, 6)));
        assertEquals(Set.of(), Intersection.intersectionRetainAll(Set.of(1, 2, 3), Set.of()));
        assertEquals(Set.of(4, 5, 6), Intersection.intersectionRetainAll(Set.of(1, 2, 3, 4, 5, 6), Set.of(4, 5, 6)));
        assertEquals(Set.of(1, 2, 3), Intersection.intersectionRetainAll(Set.of(1, 2, 3), Set.of(1, 2, 3)));
    }
}