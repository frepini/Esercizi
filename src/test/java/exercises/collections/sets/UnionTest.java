...
class UnionTest {
    ...
    void union() {
        ...
        assertEquals(Set.of(1, 2, 3, 4, 5, 6), Union.union(Set.of(1, 2, 3, 4, 5, 6), Set.of(4, 5, 6)));
        assertEquals(Set.of(1, 2, 3), Union.union(Set.of(1, 2, 3), Set.of(1, 2, 3)));
    }
    ...
    void unionAddAll() {
        ...
        assertEquals(Set.of(1, 2, 3, 4, 5, 6), Union.unionAddAll(Set.of(1, 2, 3, 4, 5, 6), Set.of(4, 5, 6)));
        assertEquals(Set.of(1, 2, 3), Union.unionAddAll(Set.of(1, 2, 3), Set.of(1, 2, 3)));
    }
}