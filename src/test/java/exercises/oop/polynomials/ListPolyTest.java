...
class ListPolyTest {
    ...
    @BeforeEach
    void setUp() {
        p1 = new ListPoly(new double[] {1, 2, 3, 4});
        p2 = new ListPoly(new double[] {10, 4, 2, 7, 1});
        p1_copy = new ListPoly(new double[] {1, 2, 3, 4});
    }
    ...
    @Test
    void derivative() {
        assertEquals(new ListPoly(new double[] {2, 6, 12}), p1.derivative());

        assertEquals(new ListPoly(new double[] {4, 4, 21, 4}), p2.derivative());
    }
