...
class PolygonTest {
    ...
    @BeforeEach
    void setUp() {
        square = new Polygon(new Point2D.Double[] {
                new Point2D.Double(0, 0),
                new Point2D.Double(0, 10),
                new Point2D.Double(10, 10),
                new Point2D.Double(10, 0)});
        triangle = new Polygon(new Point2D.Double[] {
                new Point2D.Double(0, 0),
                new Point2D.Double(10, 0),
                new Point2D.Double(5, 10)});
        oddPoly = new Polygon(new Point2D.Double[] {
    ...
    void getVerticesCount() {
        ...
        assertEquals(20, oddPoly.getVerticesCount());
    }
    ...
    void getPerimeter() {
        ...
        assertEquals(44, oddPoly.getPerimeter(), DELTA);
    }
    ...
    void getArea() {
        ...
        assertEquals(48, oddPoly.getArea(), DELTA);
    }

    @Test
    void testToString() {
        assertEquals("Polygon{vertices=[Point2D.Double[0.0, 0.0], Point2D.Double[0.0, 10.0], Point2D.Double[10.0, 10.0], Point2D.Double[10.0, 0.0]]}", square.toString());
        assertEquals("Polygon{vertices=[Point2D.Double[0.0, 0.0], Point2D.Double[10.0, 0.0], Point2D.Double[5.0, 10.0]]}", triangle.toString());
    }
}